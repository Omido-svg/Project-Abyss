...
public sealed class GameSystemVerificationWindow : EditorWindow
{
    ...
    public static void Open()
    {
        ...
        window.titleContent =
            new GUIContent("Game Verification");
    ...
    private void DrawHeader()
    {
        ...
        EditorGUILayout.HelpBox(
            "0915 Canonical Spec을 독립 Test Oracle로 사용합니다. " +
            "Runtime 설정값을 기대값으로 재사용하지 않으며, " +
        ...
        {
            EditorGUILayout.LabelField(
                $"Spec: {CanonicalGameSystemVerificationSpec.SpecId}",
        ...
        battleManager =
            (BattleManager)EditorGUILayout.ObjectField(
                "Live BattleManager",
                battleManager,
    ...
    private void DrawCoverage()
    {
        ...
        int phaseACovered =
            CanonicalGameSystemVerificationSpec.PhaseARequirements
                .Count(id => coverage.ContainsKey(id));

        int phaseBCovered =
            CanonicalGameSystemVerificationSpec.PhaseBRequirements
                .Count(id => coverage.ContainsKey(id));
        ...
        {
            EditorGUILayout.HelpBox(
                "Phase B verification pending: " +
                string.Join(", ", missingB),
                MessageType.None);
        }
    }
        ...
        using (new EditorGUILayout.HorizontalScope())
        {
            ...
            using (new EditorGUI.DisabledScope(!canRunRuntime))
            {
                        ...
                        GUILayout.Height(30f)))
                {
                    Run(
                        GameSystemVerificationRunner
                            .RunLivePlanAudit(battleManager));
                }
            }
    ...
    private void DrawReport()
    {
        ...
        {
            EditorGUILayout.HelpBox(
                "아직 실행한 Verification Report가 없습니다.",
                MessageType.None);
            return;
        }
    ...
    private void Run(
        GameSystemVerificationReport newReport)
    {
        report = newReport;
