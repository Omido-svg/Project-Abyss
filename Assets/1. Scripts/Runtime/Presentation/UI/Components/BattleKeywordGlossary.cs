...
public static class BattleKeywordGlossary
{
    private static readonly Dictionary<string, string> descriptions =
        new(System.StringComparer.Ordinal)
        {
            ...
            ["힘"] =
                "수치형 N·T 상태입니다. 살아 있는 힘 N 총합만큼 모든 굴림 위력을 올립니다. 각 부여 Entry의 지속은 독립적으로 감소합니다.",
            ["쇠약"] =
                "수치형 N·T 상태입니다. 살아 있는 쇠약 N 총합만큼 모든 굴림 위력을 내립니다. 힘과 저장 단계에서 서로 지우지 않습니다.",
            ["견고"] =
                "수치형 N·T 상태입니다. 받는 흐트러짐 피해를 N만큼 감소시킵니다. 무장해제와 계산 단계에서 대수합합니다.",
            ["무장해제"] =
                "수치형 N·T 상태입니다. 받는 흐트러짐 피해를 N만큼 증가시킵니다. 견고와 계산 단계에서 대수합합니다.",
            ["골절"] =
                "수치형 N·T 상태입니다. 굴림 최댓값만 N만큼 낮춥니다. 힘·쇠약의 범위 이동과 별도 축입니다.",
            ["보호"] =
                "수치형 N·T 상태입니다. 받는 체력 피해를 N만큼 감소시킵니다. 균열과 계산 단계에서 대수합합니다.",
            ["균열"] =
                "수치형 N·T 상태입니다. 받는 체력 피해를 N만큼 증가시킵니다. 보호와 계산 단계에서 대수합합니다.",
            ["열기"] =
                "수치형 N·T 상태입니다. 턴 종료마다 살아 있는 열기 N 총합만큼 위세 게이지를 올린 뒤 각 Entry의 지속이 1 감소합니다.",
            ["침체"] =
                "수치형 N·T 상태입니다. 턴 종료 위세 변화에서 열기와 대수합되어 위세 게이지를 N만큼 낮춥니다.",
            ["신속"] =
                "수치형 N·T 상태입니다. 속도 굴림 최댓값을 N만큼 올립니다. 즉시 부여와 다음 턴 예약은 적용 시점만 다릅니다.",
            ["재생"] =
                "수치형 N·T 상태입니다. 턴 종료마다 체력 N과 흐트러짐 N을 각각 회복한 뒤 지속이 감소합니다.",
            ["고통"] =
                "값 없는 지속형 상태입니다. 활성 중 체력·흐트러짐 회복량을 한 번만 절반으로 줄입니다. 재부여 시 효과는 중첩하지 않고 남은 지속시간을 max로 갱신합니다.",
            ["공포"] =
                "올라프 전용 값 없는 지속형 상태입니다. 활성 중 상대 굴림 위력을 고정 -1 합니다. 중첩하지 않고 지속시간만 max로 갱신합니다.",
            ["지정"] =
                "유진 전용 수치형 N·T 상태입니다. 해당 대상에 표식이 실제로 쌓일 때 살아 있는 지정 N 총합만큼 추가 표식을 더합니다.",
            ["화상"] =
        ...
        StatusEffectId id)
    {
        return id switch
        {
            ...
            StatusEffectId.Stagnation => "침체",
            StatusEffectId.Swift => "신속",
            StatusEffectId.Regeneration => "재생",
            StatusEffectId.Pain => "고통",
            StatusEffectId.Designation => "지정",
            StatusEffectId.Fear => "공포",
            _ => id.ToString()
        };
    }
}