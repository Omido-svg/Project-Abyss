...
public static class BattleKeywordGlossary
{
    private static readonly Dictionary<string, string> descriptions =
        new(System.StringComparer.Ordinal)
        {
            ...
            ["열기"] =
                "크기형 상태입니다. 이번 턴에 부여되면 즉시 위세 게이지 +N을 1회 적용하고, 다음 턴 예약분은 TurnStart에 +N을 1회 적용한 뒤 소멸합니다.",
            ["신속"] =
                "크기형 상태입니다. 다음 턴 속도 굴림의 최댓값을 +N 올리고 그 턴이 끝나면 소멸합니다.",
            ["재생"] =
                "지속형 상태입니다. 스택은 남은 턴 수이며, 지속되는 동안 매 턴 종료에 회복을 적용합니다.",
            ["고통"] =
                "지속형 상태입니다. 스택은 남은 턴 수이며, 활성 중 양수 회복량을 절반으로 줄입니다(버림, 최소 1). 중첩하지 않고 재부여 시 지속시간을 갱신합니다.",
            ["화상"] =
