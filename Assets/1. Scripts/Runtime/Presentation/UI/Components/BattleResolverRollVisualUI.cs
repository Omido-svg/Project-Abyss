    ...
    MonoBehaviour
{
        ...
        System.Random random)
    {
        ...
        while (elapsed < duration)
        {
            ...
            equationText.text =
                lockedCount <= 0
                    ? $"기본위력 {result?.BasePower ?? 0} + ..."
                    : BuildCoinPartialEquation(
                        result,
                        lockedCount);
        ...
        System.Random random)
    {
        ...
        while (elapsed < duration)
        {
            ...
            equationText.text =
                lockedCount <= 0
                    ? $"기본위력 {result?.BasePower ?? 0} + 주사위..."
                    : BuildDicePartialEquation(
                        result,
                        lockedCount);
        ...
        System.Random random)
    {
        ...
        while (elapsed < duration)
        {
            ...
            equationText.text =
                t >= 0.82f
                    ? BuildChinchiroEquation(
                        result,
                        clashPower)
                    : $"기본위력 {result?.BasePower ?? 0} + 3D6...";
