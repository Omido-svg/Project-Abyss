...
public sealed class Yujin : Character, ICharacterAuthoringTarget, IPhysicalDamageTypeProvider
{
    ...
    {
        return bundle != null &&
               bundle.Kind == CharacterAuthoringKind.Yujin &&
    ...
    protected override void BuildBodyParts()
    {
        ...
        bodyParts.Add(
            new BodyPart(PartType.HEAD, hp));

        bodyParts.Add(
            new BodyPart(PartType.LEFT_HAND, hp));

        bodyParts.Add(
            new BodyPart(PartType.RIGHT_HAND, hp));

        bodyParts.Add(
            new BodyPart(PartType.LEGS, hp));
    }
